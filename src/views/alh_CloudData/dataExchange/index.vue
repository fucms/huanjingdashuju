        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="系统名">
                    <el-input v-model="listQuery.filter" placeholder="请输入系统名"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="系统名" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="采集方式" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag :type="row.type3 == 0 ? '' : 'success'">{{ row.type3 == 0 ? '定时采集' : '实时采集' }}</el-tag>
                    </template>
                </el-table-column>
