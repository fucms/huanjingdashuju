    ...
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="服务接口名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入服务接口名称"></el-input>
                </el-form-item>
                <el-form-item label="接口类型">
                    <el-input v-model="listQuery.filter" placeholder="请输入接口类型"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                style="width: 100%">
                <el-table-column label="服务接口名称" prop="index" align="center" min-width="50">
