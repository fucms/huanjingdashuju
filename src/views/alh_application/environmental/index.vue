        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="文件名">
                    <el-input v-model="listQuery.filter" placeholder="请输入文件名"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="文件名" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="类别" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag :type="row.type3 == 0 ? '' : 'success'">{{ row.type3 == 0 ? '大气环境' : '废水和废气' }}</el-tag>
                    </template>
                </el-table-column>
