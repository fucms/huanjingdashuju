        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="公文名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入公文名称"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="公文名称" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="流转状态" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag :type="row.type3 == 0 ? '' : 'success'">{{ row.type3 == 0 ? '监测站科室审核' : '监测站科室审核' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="下一环节" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
