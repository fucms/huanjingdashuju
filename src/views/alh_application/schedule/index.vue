        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="文件名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入文件名称"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="文件名称" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="日期" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.time }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="文件类别" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag :type="row.type3 == 0 ? '' : 'success'">{{ row.type3 == 0 ? '日志' : '计划' }}</el-tag>
                    </template>
                </el-table-column>
